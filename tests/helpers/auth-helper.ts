  ...
  return {
    user: user
      ? ({
          ...
          createdAt: 'createdAt' in user ? user.createdAt : new Date(),
          updatedAt: 'updatedAt' in user ? user.updatedAt : new Date(),
          endedAt: 'endedAt' in user ? user.endedAt : null,
          scheduledDeletionAt: 'scheduledDeletionAt' in user ? user.scheduledDeletionAt : null,
          ...user,
        } as User)
      : null,
    session: session
